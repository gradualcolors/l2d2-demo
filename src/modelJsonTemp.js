...
var texElem = document.getElementById("texElem");



var modelElem = document.getElementById("modelElem"),
	textLog = document.getElementById("textLog");

var jsonPrint = document.getElementById("jsonPrint"),
...
function handleTexture(files) {
	if (!files.length) {
		textLog.innerHTML = "No Texture has been selected";
	} else {
		for (var i = 0; i < files.length; i++) {

			textureBlob = window.URL.createObjectURL(files[i]);
		}
	}
}
...
function handleModel(files) {
	if (!files.length) {
		textLog.innerHTML = "No Model has been selected";
	} else {
		for (var i = 0; i < files.length; i++) {

			modelBlob = window.URL.createObjectURL(files[i]);

		}
	}
}

modelJsonTemp.prototype.createJSON = function () {

	var charSelect = document.getElementById("char1");
	var char_name = charSelect.options[charSelect.selectedIndex].value;
	...
	modelJson = {
		...
		"expressions": [
			{ "name": "expression_name", "file": "expression_file" }
		],
		"motions": {
			"motion": [
				...
				{ "name": "doll_1", "file": "assets/motions/doll_1.mtn" },
				{ "name": "doll_2", "file": "assets/motions/doll_2.mtn" },
				{ "name": "doll_3", "file": "assets/motions/doll_3.mtn" },
				...
				{ "name": "salute_1", "file": "assets/motions/salute_1.mtn" },
				{ "name": "salute_2", "file": "assets/motions/salute_2.mtn" },
				{ "name": "salute_3", "file": "assets/motions/salute_3.mtn" },
