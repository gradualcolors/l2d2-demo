...
function main()
{
    ...
    this.modelJsonTmp = new modelJsonTemp();
...
function initModelSelection()
{
    ...
    var path = "http://"+window.location.host +"/assets/natsume/config.model.json";
    var modelJson = { };
...
function chg_expr() {
    this.live2DMgr.changeExpression();
}
...
{
    var modelList = document.getElementById("modelElem");
    var texList = document.getElementById("texElem");
    var textLog = document.getElementById("textLog");

    if (!modelList.files.length || !texList.files.length) {

        textLog.innerHTML = "No files have been selected";
        return;
    }
